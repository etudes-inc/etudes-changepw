/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/changepw/trunk/changepw-webapp/webapp/src/java/org/etudes/changepw/cdp/ChangePwServlet.java $
 * $Id: ChangePwServlet.java 5589 2013-08-13 02:19:46Z ggolden $
 ***********************************************************************************
 *
...
{
	/** Our log (commons). */
	private static Log M_log = LogFactory.getLog(ChangePwServlet.class);
	...
	public void init(ServletConfig config) throws ServletException
	{
		...
		final CdpHandler handler = new ChangePwCdpHandler();
